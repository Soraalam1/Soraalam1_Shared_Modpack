...
2. Install the latest [Arcropolis](https://github.com/Raytwo/ARCropolis/releases) release on your SD card.
...
3. When the terminal opens, paste in `git clone https://github.com/Soraalam1/Soraalam1_Shared_Modpack.git` and press enter.
...
6. Copy everything inside of the `Soraalam1_Shared_Modpack` folder that appeared during the `git clone` on your PC and paste it into the root of your Switch's SD card.
...
4. Copy everything inside of the `Soraalam1_Shared_Modpack` folder that you have on your PC and paste it into the root of your Switch's SD card.
